...
![](attachment/2023-08-31-11-28-32.png)
...
如果不符合预期，您可以自行修改`core\ArmInterface.py`中的`self.chess_table`中的值，可以通过[myBlockly](https://www.elephantrobotics.com/download/)等软件辅助操作
